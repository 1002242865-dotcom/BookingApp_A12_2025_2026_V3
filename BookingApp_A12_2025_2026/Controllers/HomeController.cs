...
namespace BookingApp_A12_2025_2026.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //prompt = "انت مرشد قدير في تدريس بسيخومتري";
            //prompt += " امامك سؤال وله اربع خيارات";
            //prompt += " مثلث زاويته الاولى 40 والثانية 80، جد مقدار الثالثة";
            //prompt += "1. 40 2.60 3.120 4.50";
            //prompt += "الاجابة الصحيحة هي الثانية 60";
            //prompt += " اعطني شرح او تلميح اعرضه للطالب";
            //prompt += " اكتب شرح قصير حتى 100 كلمة";

            prompt = "وزني 100 كغم وقمت بالمشي الخفيف لمسافة 5 كم خلال 60 دقيقة، كم كالوري حرقتjust the final number:";
